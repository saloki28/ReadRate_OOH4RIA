...
{
        /*PROTECTED REGION ID(ReadRate_e4Gen.ApplicationCore.CEN.ReadRate_E4_Evento_crearEvento_customized) ENABLED START*/
        ...
        if (p_fecha < DateTime.Now) {
                throw new ModelException ("No se puede crear una fecha de evento en el pasado");
        }
        ...
        if (p_administradorEventos != -1) {
                ...
                throw new ModelException ("Un evento debe estar asociado a un administrador");
        }
