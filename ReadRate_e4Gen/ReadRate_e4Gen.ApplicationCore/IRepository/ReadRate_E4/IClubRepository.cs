...
System.Collections.Generic.IList<ReadRate_e4Gen.ApplicationCore.EN.ReadRate_E4.ClubEN> DameClubPorFiltros (string p_nombre, string p_descripcion, int first, int size);
}
}
